namespace DatabaseExtended.Tests
{
    ...
    public class ExtendedDatabaseTests
    {
        ...
        private const string AddMaxNumReachedException = "Array's capacity must be exactly 16 integers!";
        ...
        private const long ValidIdIvan = 10002;
        ...
        public void Ctor_WithValidEmptyParameter_CreatesNewInstance()
        {
        ...
        public void Ctor_WithTooManyPeople_ThrowsException()
        {
            ...
            {
                tooManyPeople[i] = new Person(ValidIdPesho + 1, $"{ValidIdPesho}-i");
            }
        ...
        public void Add_DatabaseIsFull_ThrowsException()
        {
            ...
            Exception ex = Assert.Throws<InvalidOperationException>(
                () => sut.Add(new Person(33333333, "Petkan")));
            Assert.That(ex.Message, Is.EqualTo(AddMaxNumReachedException));
        }
        ...
        public void Add_UserNameExists_ThrowsException()
        {
            ...
            Exception ex = Assert.Throws<InvalidOperationException>(
                () => sut.Add(new Person(33333333, ValidUserNamePesho)));
        ...
        [Test]
        public void FindByUerName_HappyPath_ReturnsUser()
        {
        ...
        [Test]
        public void FindByUerName_UserNameNull_ThrowsException()
        {
            ArgumentException ae = Assert.Throws<ArgumentNullException>(() => sut.FindByUsername(null));

        }

        [Test]
        public void FindByUerName_UserIsWhiteSpace_ThrowsException()
        {
